                  ...
                  <tbody>
                    @foreach($albums as $album)                      
                        <tr>
                          ...
                          <td><a href="{{ route('admin.photo.index', ['album_id' => $album->id] ) }}"><img class='apercu' src="{{ count($album->photos) > 0 ? asset('storage/images/'.$album->nom_route.'/'.$album->photos->first()->nom_fichier) : '' }}"></a></td>
